...
let aAudio = new Audio('/sounds/Leccion7/Ej1/1.wav');
let eAudio = new Audio('/sounds/Leccion7/Ej1/2.wav');
let iAudio = new Audio('/sounds/Leccion7/Ej1/3.wav');
let oAudio = new Audio('/sounds/Leccion7/Ej1/4.wav');
let uAudio = new Audio('/sounds/Leccion7/Ej1/5.wav');
...
function showQuetions(index){
    ...
    let que_tag = '<span>'+ '<img src="/Images/Leccion/Leccion7/Ej1/'+questions[index].numb+'.png" width="490" height="250" alt="">'+'</span>';
...
function showResult(){
    ...
    link = `/paginas/Leccion7Finish?puntos=${userScore}`;
    winAudio.play();
