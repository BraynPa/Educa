...
let aAudio = new Audio('./sounds/Leccion3/Pag27/vi.wav');
let eAudio = new Audio('./sounds/Leccion3/Pag13/gudi.wav');
let iAudio = new Audio('./sounds/Leccion3/Pag13/gui.wav');
let oAudio = new Audio('./sounds/Leccion3/Pag19/ma.wav');
let uAudio = new Audio('./sounds/Leccion3/Pag30/yo.wav');
