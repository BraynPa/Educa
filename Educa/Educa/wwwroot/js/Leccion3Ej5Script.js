...
let aAudio = new Audio('./sounds/Leccion3/Pag20/no.wav');
let eAudio = new Audio('./sounds/Leccion3/Pag21/nio.wav');
let iAudio = new Audio('./sounds/Leccion3/Pag20/ne.wav');
let oAudio = new Audio('./sounds/Leccion3/Pag21/nie.wav');
let uAudio = new Audio('./sounds/Leccion3/Pag31/zo.wav');
